    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="left-header col horizontal-wrapper ps-0">
            <ul class="horizontal-menu">
                <li class="mega-menu outside"><a class="nav-link" href="<?php echo e(route('uif.index')); ?>" data-bs-original-title="" title=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg><span>Siteye Git</span></a>
                </li>
                ...
                <li class="profile-nav onhover-dropdown p-0 me-0">
                    <div class="media profile-media">
                        ...
                        <div class="media-body"><span><?php echo e(auth('management')->user()->name_surname); ?></span>
                                                    <p class="mb-0 font-roboto"><?php echo e(auth('management')->user()->isit_executive == 0 ? "Misafir" : ( auth('management')->user()->isit_executive == 1 ? "Admin" : "Kullanıcı" )); ?> <i class="middle fa fa-angle-down"></i></p>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/haber.aytacipekel.com/resources/views/management/layouts/partials/header.blade.php ENDPATH**/ ?>