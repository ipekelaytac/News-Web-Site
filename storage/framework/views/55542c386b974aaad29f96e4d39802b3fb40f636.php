                                        ...
                                        <div class="blog-box">
                                            <div class="post-media">
                                                <a href="<?php echo e(route('uif.news.detail', $entry->slug)); ?>" title="">
                                                    <img src="/uif/upload/tech_menu_01.jpg" alt="" class="img-fluid">
                                            ...
                                            <div class="blog-meta big-meta">
                                                ...
                                                <p><?php echo Str::limit($entry->content,100,'...'); ?></p>
                                                        Kategori:    <small><a href="<?php echo e(route('uif.news.category_news', $entry->cate_slug)); ?>" title=""><?php echo e($entry->category_name); ?></a></small>
...
<?php echo $__env->make('uif.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NewsWeb-Site/resources/views/uif/category.blade.php ENDPATH**/ ?>