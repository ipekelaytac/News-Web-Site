<?php $__env->startSection('title', 'Blog Kategori Yönetimi'); ?>
            ...
            <div class="page-title">
                ...
                <div class="page-title">
                    <div class="pull-right">
                        <a class="btn btn-success" href="<?php echo e(route('management.category.add')); ?>">Yeni Ekle</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                                ...
                                <table class="display" id="tblTable">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span><?php echo e($entry->category_name); ?></span>
                                            </td>
                                            <td>
                                                <a data-toggle="modal" data-target="#delete-<?php echo e($entry->id); ?>"
                                                   class="btn btn-danger " type="button">Sil
                                                </a>
                                                <a href="<?php echo e(route('management.category.update', $entry->id)); ?>">
                                                    <button class="btn btn-success btn-xs" type="button"
                                                            data-original-title="btn btn-danger btn-xs" title="">Düzenle
                                                    </button>
                                                </a>
                                            </td>
                                                ...
                                                <div class="modal-dialog mt-0 mb-0" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo e(route('management.category.delete', $entry->id)); ?>"
                        ...
                        document.getElementById('delete').submit();"
                                                            ...
                                                            <form id="delete"
                                                                  action="<?php echo e(route('management.category.delete', $entry->id)); ?>"
...
<?php echo $__env->make('management.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NewsWeb-Site/resources/views/management/category/category.blade.php ENDPATH**/ ?>