                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="<?php echo e(route('uif.news.detail', $entry->slug)); ?>" title="">
                                                <img src="<?php echo e($entry->image!=null ? asset('uploads/news/' . $entry->image) : 'https://via.placeholder.com/300?text=HaberResmi'); ?>" alt="" class="img-fluid">
                                        ...
                                        <div class="blog-meta big-meta">
                                            ...
                                            <?php $__currentLoopData = $news_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($category->news_id == $entry->id): ?>
                                                    Kategori:    <small><a href="<?php echo e(route('uif.news.category_news', $category->category->slug)); ?>" title=""><?php echo e($category->category->category_name); ?></a></small>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('uif.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/NewsWeb-Site/resources/views/uif/news.blade.php ENDPATH**/ ?>