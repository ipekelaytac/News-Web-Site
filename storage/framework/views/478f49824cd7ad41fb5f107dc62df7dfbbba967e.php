                            ...
                            <form class="row needs-validation"  action="<?php echo e(route('management.news.save', $entry->id)); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="validationCustom01" type="text" name="title" placeholder="Haber Başlığı" value="<?php echo e(old('title', $entry->title)); ?>">
                                    </div>
...
<?php echo $__env->make('management.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aytacipekel/haber.aytacipekel.com/resources/views/management/news/form.blade.php ENDPATH**/ ?>