                ...
                <div class="widget">
                    <div class="footer-text text-left">
                        ...
                        <div class="newsletter-widget text-left">
                            <form class="form-inline" method="post" action="{{route('uif.subscriber')}}">
                                {{csrf_field()}}
            ...
            <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                <div class="widget">
                    ...
                    <div class="link-widget">
                        <ul>
                            <li>
                                <a  href="{{route('uif.index')}}">AnaSayfa</a>
                            </li>
                            <li >
                                <a  href="{{route('uif.news')}}">Haberler</a>
                            </li>
                            <li >
                                <a  href="{{route('uif.contact')}}">İletişim</a>
                            </li>
                            <li>
                                <a  href="{{route('uif.aboutus')}}">Hakkımızda</a>
                            </li>
