                ...
                <div class="row">
                    ...
                    <div class="page-title">
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{route('management.user.add')}}">Yeni Ekle</a>
                        </div>
                    </div>
            </div>
        </div>
                            ...
                            <div class="table-responsive product-table">
                                <table class="display" id="tblTable">
                                    ...
                                    <tr>
                                        <td>#{{ $entry->id }}</td>
                                        <td>
                                            <span>{{ $entry->name_surname}}</span>
                                        </td>
                                        <td>{{ $entry->email }}</td>
                                        <td class="font-success">{{  $entry->isit_executive == 1 ? "Admin" : "Kullanıcı"  }}
                                        </td>
                                        <td>
                                            ...
                                            <a href="{{ route('management.user.update', $entry->id) }}"><button class="btn btn-success btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="">Düzenle</button></a>
                                        </td>
                                            ...
                                            <div class="modal-dialog mt-0 mb-0" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('management.user.delete', $entry->id) }}"
